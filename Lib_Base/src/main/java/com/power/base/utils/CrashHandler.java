...
import com.power.base.BuildConfig;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public static void init(Context context, boolean isDebugMode) {
        getInstance().innerInit(context, isDebugMode);
    }

    private void innerInit(Context context, boolean isDebugMode) {
...
//        final String crashReport = getCrashReport(throwable);
        String deviceInfo = getAppEnvironmentInfo();
        String crashReport = getTraceInfo(throwable);
        Log.e(TAG, crashReport);

//        CrashReportActivity.startActivity(mContext, mIsDebugMode, deviceInfo, crashReport);
    ...
    private String getAppEnvironmentInfo() {
        try {
            ...
            sb
                    ...
                    .append("Version info:").append(getVersionInfo(mContext)).append("\n")
                    .append("Device info:").append(getDeviceInfo()).append("\n");
            return sb.toString();
